...
| 4 | A definir | Espaço preparado para a próxima etapa |
| 5 | A definir | Espaço preparado para a próxima etapa |

Novas aulas devem ser adicionadas em pastas com o mesmo padrão de nomes, como `aula-04/` e `aula-05/`. Cada nova versão deve preservar o que já foi aprendido e acrescentar somente o conteúdo previsto para aquele encontro.
